...
// Fallback 2.5D della pagina Dispositivi (per reduced-motion / assenza di WebGL):
// parete museale a scorrimento verticale — spina cronologica dei dispositivi.
// Ogni nodo mostra immagine + anno + nome; il click apre una scheda "post-it"
// trascinabile; "Percorsi" (in alto a destra) illumina i dispositivi di un
// autore o di un tema.
...
export default function DispositivoFallback() {
  ...
  const [pathTab, setPathTab] = useState("author");
